...
namespace MvcApp.ServiceReference1 {
    ...
    public partial class Physician : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private MvcApp.ServiceReference1.ContactInfo ContactInfoField;
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private MvcApp.ServiceReference1.Specialization SpecializationField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public MvcApp.ServiceReference1.ContactInfo ContactInfo {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public MvcApp.ServiceReference1.Specialization Specialization {
            get {
    ...
    public partial class ContactInfo : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private MvcApp.ServiceReference1.Physician PhysicianField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public MvcApp.ServiceReference1.Physician Physician {
            get {
    ...
    public interface IMyService {
        ...
        MvcApp.ServiceReference1.Physician[] GetAllPersonalInfo();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMyService/GetAllPersonalInfo", ReplyAction="http://tempuri.org/IMyService/GetAllPersonalInfoResponse")]
        System.Threading.Tasks.Task<MvcApp.ServiceReference1.Physician[]> GetAllPersonalInfoAsync();
        ...
        int AddUser(string FirstName, string MiddleName, string LastName, System.DateTime BirthDate, string Gender, int Weight, int Height, string HomeAddress, long HomePhone, string OfficeAddress, long OfficePhone, string EmailAdd, long CellphoneNumber, string Name, string Description);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMyService/AddUser", ReplyAction="http://tempuri.org/IMyService/AddUserResponse")]
        System.Threading.Tasks.Task<int> AddUserAsync(string FirstName, string MiddleName, string LastName, System.DateTime BirthDate, string Gender, int Weight, int Height, string HomeAddress, long HomePhone, string OfficeAddress, long OfficePhone, string EmailAdd, long CellphoneNumber, string Name, string Description);
        ...
        MvcApp.ServiceReference1.Physician GetAllUserById(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMyService/GetAllUserById", ReplyAction="http://tempuri.org/IMyService/GetAllUserByIdResponse")]
        System.Threading.Tasks.Task<MvcApp.ServiceReference1.Physician> GetAllUserByIdAsync(int id);
        ...
        int UpdateUser(string FirstName, string MiddleName, string LastName, System.DateTime BirthDate, string Gender, int Weight, int Height, string HomeAddress, long HomePhone, string OfficeAddress, long OfficePhone, string EmailAdd, long CellphoneNumber, string Name, string Description);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMyService/UpdateUser", ReplyAction="http://tempuri.org/IMyService/UpdateUserResponse")]
        System.Threading.Tasks.Task<int> UpdateUserAsync(string FirstName, string MiddleName, string LastName, System.DateTime BirthDate, string Gender, int Weight, int Height, string HomeAddress, long HomePhone, string OfficeAddress, long OfficePhone, string EmailAdd, long CellphoneNumber, string Name, string Description);
    ...
    public partial class MyServiceClient : System.ServiceModel.ClientBase<MvcApp.ServiceReference1.IMyService>, MvcApp.ServiceReference1.IMyService {
        ...
        public MvcApp.ServiceReference1.Physician[] GetAllPersonalInfo() {
            return base.Channel.GetAllPersonalInfo();
        }
        
        public System.Threading.Tasks.Task<MvcApp.ServiceReference1.Physician[]> GetAllPersonalInfoAsync() {
            return base.Channel.GetAllPersonalInfoAsync();
        }
        
        public int AddUser(string FirstName, string MiddleName, string LastName, System.DateTime BirthDate, string Gender, int Weight, int Height, string HomeAddress, long HomePhone, string OfficeAddress, long OfficePhone, string EmailAdd, long CellphoneNumber, string Name, string Description) {
            return base.Channel.AddUser(FirstName, MiddleName, LastName, BirthDate, Gender, Weight, Height, HomeAddress, HomePhone, OfficeAddress, OfficePhone, EmailAdd, CellphoneNumber, Name, Description);
        }
        
        public System.Threading.Tasks.Task<int> AddUserAsync(string FirstName, string MiddleName, string LastName, System.DateTime BirthDate, string Gender, int Weight, int Height, string HomeAddress, long HomePhone, string OfficeAddress, long OfficePhone, string EmailAdd, long CellphoneNumber, string Name, string Description) {
            return base.Channel.AddUserAsync(FirstName, MiddleName, LastName, BirthDate, Gender, Weight, Height, HomeAddress, HomePhone, OfficeAddress, OfficePhone, EmailAdd, CellphoneNumber, Name, Description);
        }
        
        public MvcApp.ServiceReference1.Physician GetAllUserById(int id) {
            return base.Channel.GetAllUserById(id);
        }
        
        public System.Threading.Tasks.Task<MvcApp.ServiceReference1.Physician> GetAllUserByIdAsync(int id) {
            return base.Channel.GetAllUserByIdAsync(id);
        }
        
        public int UpdateUser(string FirstName, string MiddleName, string LastName, System.DateTime BirthDate, string Gender, int Weight, int Height, string HomeAddress, long HomePhone, string OfficeAddress, long OfficePhone, string EmailAdd, long CellphoneNumber, string Name, string Description) {
            return base.Channel.UpdateUser(FirstName, MiddleName, LastName, BirthDate, Gender, Weight, Height, HomeAddress, HomePhone, OfficeAddress, OfficePhone, EmailAdd, CellphoneNumber, Name, Description);
        }
        
        public System.Threading.Tasks.Task<int> UpdateUserAsync(string FirstName, string MiddleName, string LastName, System.DateTime BirthDate, string Gender, int Weight, int Height, string HomeAddress, long HomePhone, string OfficeAddress, long OfficePhone, string EmailAdd, long CellphoneNumber, string Name, string Description) {
            return base.Channel.UpdateUserAsync(FirstName, MiddleName, LastName, BirthDate, Gender, Weight, Height, HomeAddress, HomePhone, OfficeAddress, OfficePhone, EmailAdd, CellphoneNumber, Name, Description);
        }
